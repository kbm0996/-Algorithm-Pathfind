...
mylib::CJPS::stArea::stArea(int x, int y, stArea * parent)
{
	iX = x;
	iY = y;
	G = 0;
...
bool mylib::CJPS::PathFind_Process()
{
	if (_bStart)
	{
		_pStartPos_Temp = new stArea(_StartPos);
...
BOOL mylib::CJPS::CheckTile(int iX, int iY)
{
	// Check Range
